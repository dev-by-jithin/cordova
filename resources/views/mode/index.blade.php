        ...
        <div class="col-md-12">
            <div class="card mb-2">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="fw-bold mb-0">Modes</h5>
                </div>
                <div class="card-body pt-2 pb-1">
                    <form action="{{ route('mode.index') }}" method="GET">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $modes->firstItem() + $loop->index }}</td>
                                    <td>{{ $mode->name }}</td>
                                    <td>{{ $mode->group->name }}</td>
                                    <td>{{ $mode->sort_order }}</td>
                                    <td><span class="badge rounded-pill text-bg-{{ $mode->is_active == 'Yes' ? 'success' : 'danger' }}">{{ $mode->is_active }}</span></td>
